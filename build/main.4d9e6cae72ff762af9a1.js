...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libRoutesJsx = __webpack_require__(197);

	var _libRoutesJsx2 = _interopRequireDefault(_libRoutesJsx);

	exports['default'] = function (locals, callback) {
	  _reactRouter2['default'].run(_libRoutesJsx2['default'], locals.path, function renderRoute(Handler) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppJsx = __webpack_require__(198);

	var _AppJsx2 = _interopRequireDefault(_AppJsx);

	var _pagesAboutPageJsx = __webpack_require__(204);

	var _pagesAboutPageJsx2 = _interopRequireDefault(_pagesAboutPageJsx);

	var _pagesIndexPageJsx = __webpack_require__(205);

	var _pagesIndexPageJsx2 = _interopRequireDefault(_pagesIndexPageJsx);

	var Routes = _react2['default'].createElement(
	  _reactRouter.Route,
	  { handler: _AppJsx2['default'], path: '/' },
	  _react2['default'].createElement(_reactRouter.DefaultRoute, { handler: _pagesIndexPageJsx2['default'] }),
	  _react2['default'].createElement(_reactRouter.Route, { handler: _pagesAboutPageJsx2['default'], path: '/about' })
	);
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement('script', { src: this.props.assets.main })
	        )
	      );
	    }
	  }], [{
